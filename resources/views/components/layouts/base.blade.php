...
<head>
    ...
    <meta property="og:image" content="https://feralpisalo.demo.wprecovery.com/storage/{{ $immagine_evidenza }}" />
    <meta property="twitter:image" content="https://feralpisalo.demo.wprecovery.com/storage/{{ $immagine_evidenza }}" />
...
<body class="filament-fabricator-body">
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/it_IT/sdk.js#xfbml=1&version=v18.0"
        nonce="AJslhJKC"></script>

...
<head>
    ...
    <meta property="og:image" content="https://feralpisalo.it/storage/{{ $immagine_evidenza }}" />
    <meta property="twitter:image" content="https://feralpisalo.it/storage/{{ $immagine_evidenza }}" />
